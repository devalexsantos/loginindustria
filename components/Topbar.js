            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto m-auto text-center text-sm">
              <li className="nav-item">
                <Link href="/" style={{ textDecoration: "none" }}>
                  <div className="px-3 py-2 flex items-center uppercase hover:bg-primary hover:text-white rounded mx-2">
                    INÍCIO
                  </div>
                </Link>
              </li>
              <li className="nav-item">
                <Link href="/computadores" style={{ textDecoration: "none" }}>
                  <div className="px-3 py-2 flex items-center uppercase hover:bg-primary hover:text-white hover:no-underline rounded mx-2">
                    COMPUTADORES
                  </div>
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  href="https://www.centraldedownload.com.br/"
              ...
              <li className="nav-item">
                <Link href="/suporte" style={{ textDecoration: "none" }}>
                  <div className="px-3 py-2 flex items-center uppercase hover:bg-primary hover:text-white rounded border mx-2">
                    SUPORTE
                  </div>
                </Link>
              </li>
